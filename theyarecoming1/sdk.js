...
(() => {
        ...
        if (void 0 !== e) {
            ...
            e.u = function(e) {
                ...
                return o(t).catch((function(o) {
                    ...
                    if (n < 1) {
                        var s = r(t);
                        throw o.message = "Loading chunk " + t + " failed after 3 retries.\n(" + s + ")", o.request = s, o
                    }
    ...
    var o, t = Object.defineProperty,
        ...
        d = (e, r) => {
            ...
            if (a)
                for (var o of a(r)) s.call(r, o) && i(e, o, r[o]);
            return e
        };
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.isSdkLoader = !0, window.YaGames = {
            init: o => {
                var d;
                return s ? null == (d = window.YaGames) ? void 0 : d.init(o) : i ? Promise.reject(v) : a ? (console.warn("YaGames was initialized"), a) : (a = new Promise(((a, s) => {
                    e = a, r = s, t = o, n = !0
                })), a)
            }
        };
                ...
                window.parent.postMessage({
                    ...
                    data: {
                        ...
                        additional: d(d(d({}, r), (null == (o = r.error) ? void 0 : o.message) ? {
                            originalMessage: null == (t = r.error) ? void 0 : t.message
                        } : {}), r.source ? {
        ...
        const u = e => {
            ...
            g = (o, a) => {
                ...
                d.src = o, d.onload = () => {
                    var o;
                    s = !0, n && (null == (o = window.YaGames) || o.init(t).then((r => {
                        e(r)
                    })).catch((e => {
        ...
        y ? h(y) : (o = function*() {
            return new Promise(((e, r) => {
                ...
                window.addEventListener("message", (function r(a) {
                    ...
                    n && n.messageId === o && (window.removeEventListener("message", r), clearTimeout(t), e(n.payload))
            ...
            var t = e => {
                ...
                n = r => r.done ? e(r.value) : Promise.resolve(r.value).then(t, a);
